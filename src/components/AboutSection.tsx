    ...
    >
      <div className="container mx-auto max-w-7xl flex flex-col md:flex-row items-center gap-12">
        ...
        <motion.div
          ...
          className="w-full md:w-[300px] h-[360px] bg-black rounded-3xl border border-cyan-400 p-4 glow-img transition duration-300"
        >
          <img
        ...
        <div className="flex-1">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-4xl md:text-5xl font-bold neon-text typewriter-text mb-6 text-cyan-400">
              About Me
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 h-[170px] w-full rounded-xl border border-cyan-400 bg-glass glow-box"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 h-[170px] w-full rounded-xl border border-violet-400 bg-glass glow-box"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 h-[170px] w-full rounded-xl border border-pink-400 bg-glass glow-box"
            >
