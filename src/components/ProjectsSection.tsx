        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="group p-6 rounded-xl bg-transparent border-2 border-cyan-500 hover:border-[3px] hover:border-transparent hover:shadow-[0_0_25px_5px_rgba(0,255,255,0.4)] transition-all duration-500"
            >
