    ...
    >
      <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-12">
        ...
        <motion.div
          ...
          className="w-64 h-80 rounded-3xl border-4 p-2 border-cyan-400 hover:border-gradient-to-br from-cyan-400 via-violet-500 to-pink-500 bg-black/30 backdrop-blur-md shadow-[0_0_25px_4px_rgba(0,191,255,0.5)] hover:shadow-[0_0_35px_6px_rgba(255,255,255,0.3)] transition-all duration-500"
        >
          <img
            src="/your-image.jpg"
            alt="Profile"
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-center">
            ...
            <motion.div
              whileHover={{ scale: 1.05 }}
              transition={{ duration: 0.4 }}
              className="p-6 rounded-xl border-2 bg-black/30 border-cyan-400 hover:border-gradient-to-br from-cyan-400 via-violet-500 to-pink-500 shadow-[0_0_20px_2px_rgba(0,255,255,0.3)] hover:shadow-[0_0_35px_6px_rgba(255,255,255,0.3)] backdrop-blur-md transition-all duration-500"
            >
            ...
            <motion.div
              whileHover={{ scale: 1.05 }}
              transition={{ duration: 0.4 }}
              className="p-6 rounded-xl border-2 bg-black/30 border-violet-400 hover:border-gradient-to-br from-pink-400 via-violet-500 to-blue-400 shadow-[0_0_20px_2px_rgba(216,191,216,0.3)] hover:shadow-[0_0_35px_6px_rgba(255,255,255,0.3)] backdrop-blur-md transition-all duration-500"
            >
            ...
            <motion.div
              whileHover={{ scale: 1.05 }}
              transition={{ duration: 0.4 }}
              className="p-6 rounded-xl border-2 bg-black/30 border-pink-400 hover:border-gradient-to-br from-pink-300 via-red-400 to-yellow-300 shadow-[0_0_20px_2px_rgba(255,182,193,0.3)] hover:shadow-[0_0_35px_6px_rgba(255,255,255,0.3)] backdrop-blur-md transition-all duration-500"
            >
