  ...
  return (
    ...
    >
      <div className="container mx-auto relative z-10">
        ...
        {/* Horizontal Timeline */}
        <div className="relative flex flex-col md:flex-row items-start justify-center gap-10 md:gap-8 max-w-7xl mx-auto overflow-x-auto pt-10 pb-4">
